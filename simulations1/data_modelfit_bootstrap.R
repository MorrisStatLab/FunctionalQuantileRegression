...
for(i in 1:100)
{
   ...
   write.table(result$coef1,paste0("./output/freqQR/raw/BS_betat_10_rep_",i,".txt"),quote=FALSE,sep="\t",row.names=FALSE,col.names=FALSE)
   write.table(result$coef2,paste0("./output/freqQR/raw/BS_betat_20_rep_",i,".txt"),quote=FALSE,sep="\t",row.names=FALSE,col.names=FALSE)
   ...
   write.table(result$coef1.ss,paste0("./output/freqQR/splines/BS_betat_10_rep_",i,".txt"),quote=FALSE,sep="\t",row.names=FALSE,col.names=FALSE)
   write.table(result$coef2.ss,paste0("./output/freqQR/splines/BS_betat_20_rep_",i,".txt"),quote=FALSE,sep="\t",row.names=FALSE,col.names=FALSE)
