...
% qt=0.1, and the procedures are the same for other quantiles.
...
load(sprintf('Y:/submission/simulations1/output/QR/MCMC_betat_%d_rep_1.mat',qt*100));
...
% load in posterior samples of Beta_2(t)
load(sprintf('Y:/submission/simulations1/output/HS/MCMC_betat_%d_rep_1.mat',qt*100));
...
BS_P=dlmread(sprintf('Y:/submission/simulations1/output/freqQR/raw/BS_betat_%d_rep_1.txt',qt*100));
...
% load in bootstrap samples of Beta_2(t)
BS_P=dlmread(sprintf('Y:/submission/simulations1/output/freqQR/splines/BS_betat_%d_rep_1.txt',qt*100));
...
% load in bootstrap samples of Beta_2(t)
BS_P=dlmread(sprintf('Y:/submission/simulations1/output/freqQR/wavelets/BS_betat_%d_rep_1.txt',qt*100));
